...
/* harmony import */ var _components_user_delete_user_delete_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/user-delete/user-delete.component */ "./src/app/components/user-delete/user-delete.component.ts");
/* harmony import */ var _components_messages_messages_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/messages/messages.component */ "./src/app/components/messages/messages.component.ts");
/* harmony import */ var _components_game_game_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/game/game.component */ "./src/app/components/game/game.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var _board__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../board */ "./src/app/board.ts");
...
/* harmony import */ var src_app_player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/player */ "./src/app/player.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    */
    ...
    GameComponent.prototype.ngOnInit = function () {
        ...
        self.playerOneClick = function (click) {
            var id = click.target.id, boardId = 1, row = id.substring(2, 3), col = id.substring(3, 4), tile = this.boards[boardId].tiles[row][col];
            console.log(tile);
        ...
        self.playerArrivoClick = function (click) {
            var id = click, boardId = 0, row = id.substring(2, 3), col = id.substring(3, 4), tile = this.boards[boardId].tiles[row][col];
            console.log(click);
            if (self.gamedata.turno != self.gamedata.numeroGiocatore) {
                if (!this.checkValidHit(boardId, tile)) {
                    console.log("no");
...
module.exports = __webpack_require__(/*! C:\Users\Byteman\Desktop\Università\Tecnologie ed Applicazioni Web\Progetto WAT\mobile\src\main.ts */"./src/main.ts");

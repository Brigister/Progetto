...
var GameComponent = /** @class */ (function () {
    ...
    GameComponent.prototype.ngOnInit = function () {
        ...
        self.gamedata.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_4___default.a.connect('http://localhost:3000');
...
var AuthService = /** @class */ (function () {
    function AuthService(http, _router) {
        this.http = http;
        this._router = _router;
        this._registerUrl = "http://localhost:3000/user/signup";
        this._loginUrl = "http://localhost:3000/user/login";
        this._userUrl = "http://localhost:3000/user/";
    }
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this._userUrl = 'http://localhost:3000/user/';
        this._messagesUrl = 'http://localhost:3000/messages/';
    }
